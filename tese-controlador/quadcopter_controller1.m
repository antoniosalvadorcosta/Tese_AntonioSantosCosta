function [u,ep] = quadcopter_controller1(m,p_ref,v_ref,a_ref,a_ref_dot,Parameter,p,v,a,R,W)
...
if P.wind_model_control_2 == 1
a_des = a_fb + a_ref - a_rd + P.g*zW + (1/2)*P.air_d*P.Cd*P.Pa*(v.^2).*sign(v);
end

     
if  P.rd_model_2 == 1 && P.rd_model_control_2 == 0
    disp('considering rotor drag only on the model of Drone 2');
end
   
%end
if P.rd_model_control_2 == 0
    disp('no rotor drag on Drone 2');
    ...
    disp('considering rotor drag on the model and on the controller on Drone 2');
