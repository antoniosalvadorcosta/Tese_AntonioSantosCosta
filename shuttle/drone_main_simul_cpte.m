...
for k = 1:Param.Nsim
    for iD = 1:Param.nD
        ...
        [T{iD}(:,k),tau{iD}(:,k),e_p] = drone_mellinger_ctrl_cpte(p{iD},v{iD},R,om,Param,p_d,psi_d,xiep{iD}(:,k),v_d,dpsi_d,a_d,j_d, dw_comp,other_pos{iD},other_thrust{iD},other_vel{iD});
        ...
        [dot_p,dot_v,dot_R,dot_om] = drone_3dfull_dyn_cpte(p{iD},v{iD},R,om,T{iD}(:,k),tau{iD}(:,k),F,Param,other_pos{iD},other_thrust{iD}, other_vel{iD});
